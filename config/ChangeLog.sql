...
,StatusBranchChangeLog As (
    ...
    where
        Event_TS >= (TIMESTAMP_FORMAT(VARCHAR_FORMAT(CURRENT TIMESTAMP, 'YYYY-MM-DD-HH24') || ':{logMinutesStart}:00','YYYY-MM-DD-HH24:MI:SS') - {logInterval} HOUR)
        and Event_TS <  TIMESTAMP_FORMAT(VARCHAR_FORMAT(CURRENT TIMESTAMP, 'YYYY-MM-DD-HH24') || ':{logMinutesEnd}:00','YYYY-MM-DD-HH24:MI:SS')
